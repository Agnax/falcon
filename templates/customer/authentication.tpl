    ...
    <div class="row user-form__row">
      ...
      <div class="user-form__block  col-md-6 col-12">
        <div class="user-form__content card-body h-100 d-flex flex-column">
          <h4 class="text-center h3 mb-3">
            {l s='Registrarse' d='Shop.Istheme'}
          </h4>

          <p class="mb-4 text-muted">
            {l s='¡Crear una cuenta es muy sencillo y te permitirá completar tu pedido aún más rápido! Además, tendrás la opción de rastrear tu pedido y ver tu historial de compras. ¡No te lo pierdas, es una experiencia increíble!' d='Shop.Istheme'}
          </p>
