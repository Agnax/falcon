        ...
        {if $cart.products_count > 0}
          ...
          <div class="mt-3">
            <a href="{$cart_url}" class="btn btn-sm btn-primary btn-block dropdown-close">
              {l s='¡Listo para finalizar tu compra!' d='Shop.Theme.Actions'}
            </a>
          </div>

        {else}
          <div class="alert alert-warning">
            {l s='¡Tu carrito está esperando para ser llenado de maravillosos productos!' d='Modules.Isshoppingcart.Isshoppingcart'}
          </div>
        {/if}
      </div>
    </div>
